...
namespace FluentMigrator.Infrastructure
{
    ...
    public const string RepositoryCannotBeNull = "The repository command cannot be null or empty";
    public const string ScriptPathCannotBeNullOrEmpty = "The script path cannot be null or empty";
    public const string ScriptRevisionCannotBeNullOrEmpty = "The script revision cannot be null or empty";
	}
}